...
import me from "../../../public/pic_01.jpg";
...
const AboutSection = () => {
  return (
    <div className="grid gird-cols-1 lg:grid-cols-3 gap-4 mt-4">
      <Card className="col-span-1 lg:col-span-2 border-none bg-gray-100 p-4">
        <h1 className="text-3xl lg:text-4xl text-primaryTextColor font-medium">
